...
class TestFwissr(unittest.TestCase):
    ...
    def test_default_refresh_period(self):
        registry = Registry()
        self.assertEqual(registry.refresh_period, Registry.DEFAULT_REFRESH_PERIOD)
    ...
    def test_instanciate_with_several_sources(self):
        ...
        registry = Registry()
        registry.add_source(File(tmp_conf_file('test.json'), {'top_level': True}))
        ...
        registry.add_source(File(tmp_conf_file('test2.json'), {'top_level': True}))
    ...
    def test_not_refresh_thread(self):
        ...
        registry.add_source(File(tmp_conf_file('test.json'), {'refresh': True}))
